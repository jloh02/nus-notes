 ...
 \begin{center}
    \fbox{%
        \parbox{0.8\linewidth}{\centering \textcolor{black}{
            ...
            \\ {\footnotesize Original from github.com/gerteck}
        }%
    }
  \end{center}
...
\begin{itemize}
	\item \textbf{Atomistic Fallacy}: Using individual level correlation to conclude ecological (aggregate level) correlation
	\item \textbf{Ecological Fallacy}: Using ecological (aggregate level) correlation to conclude individual level correlation
\end{itemize}
...
\begin{itemize}
	...
	\begin{center}\includegraphics[width = .75\linewidth]{leastsquares}\end{center}
...
\begin{itemize}
	...
	\begin{center}\includegraphics[width = .9\linewidth]{normaldistribution}\end{center}
\end{itemize}
...
One-sample t-test and Chi-squared test:
    ...
    \textbf{Sensitivity}: $P(\text{Positive} | \text{Has COVID})$ \\
    \textbf{Specificity}: $P(\text{Negative} | \text{Does not have COVID})$ \\
\end{multicols*}
\end{document}
